...
object OrganizingImplicits extends App {
  ...
  //mplicit val normalOrdering: Ordering[Int] = Ordering.fromLessThan(_ > _)
...
//  println(persons.sorted)
  ...
  object Purchase {
    implicit val totalPriceOrdering: Ordering[Purchase] = Ordering.fromLessThan((a,b) => a.nUnits < b.nUnits * b.unitPrice)
  }
