...
object CurriesPartiallyAppliedFunctions extends App {
  ...
  println(insertName("Severo"))

  val fillInTheBlancks = concatenator("Hello, ", _:String, _:String) //(x, y) => concatenator("Hello, ", x, y)
  println(fillInTheBlancks("Severo ", "Scala is awesome"))
